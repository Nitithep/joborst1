				...
				<div class="container">
					...
					<div id="navbar" class="navbar-nav-wrapper navbar-arrow">
						...
						<ul class="nav navbar-nav" id="responsive-menu">
							...
							<li>
								<a href="job-list.php">รายการงานที่รับสมัคร</a>

							</li>
							
							
							<li>
								<a href="https://www.orst.go.th/royin/iwfm_list.asp?p=ABOUT-CONTACT">ติดต่อเรา</a>
							</li>
		...
		<div class="main-wrapper">
			...
			<div class="hero" style="background-image:url('images/hero-header/01.jpg');">
				<div class="container">
					...
					<h1>เปิดโอกาสให้ร่วมงานกับเรา</h1>
					<p>สำนักงานราชบัณฑิตยสภา</p>
			...
			<div class="pt-0 pb-50">
				...
				<<div class="container">
                <h1 class="text-center mb-5 wow fadeInUp" data-wow-delay="0.1s">ประกาศรับสมัครงานสำนักงานราชบัณฑิตยสภา</h1>
                <div class="row">
                    <div class="col-sm-4 wow fadeInUp" data-wow-delay="0.1s">
                        <a class="cat-item rounded p-4" href="">
                            <i class="fa fa-3x fa-mail-bulk text-primary mb-4"></i>
                            <h4 class="mb-3">ประกาศรับสมัครเข้ารับข้าราชการ</h4>
                    ...
                    <div class="col-sm-4 wow fadeInUp" data-wow-delay="0.3s">
                        <a class="cat-item rounded p-4" href="">
                            ...
                            <h4 class="mb-3">ประกาศรับสมัครพนักงานราชการ</h4>
                    ...
                    <div class="col-sm-4 wow fadeInUp" data-wow-delay="0.5s">
                        <a class="cat-item rounded p-4" href="job-list.php">
                            ...
                            <h4 class="mb-3">ประกาศรับสมัครลูกจ้างเหมาบริการ</h4>
...
<script src="https://code.jquery.com/jquery-3.4.1.min.js"></script>
    ...
    <script src="configtem/lib/easing/easing.min.js"></script>
    <script src="/configtemlib/waypoints/waypoints.min.js"></script>
    <script src="configtem/lib/owlcarousel/owl.carousel.min.js"></script>
